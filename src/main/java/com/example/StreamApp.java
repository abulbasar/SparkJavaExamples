...
public class StreamApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JavaReceiverInputDStream<String> lines = ssc.socketTextStream("localhost", port, StorageLevel.MEMORY_ONLY());
        lines.print(10);
        ...
        sqlContext.udf().register("findMedia", new UDF1<String, String>() {
            ...
            public String call(String value){
                ...
                }else if(value.startsWith("http://twitter.com") || value.startsWith("http://www.twitter.com")){
                    media = "twitter.com";
                }else{
                    media = "other";
                }
